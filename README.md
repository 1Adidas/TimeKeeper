...
Mở thư mục dự án bằng trình soạn thảo Visual Studio Code.
Cài đặt tiện ích mở rộng (Extension) Live Server (của tác giả Ritwick Dey).
Click chuột phải vào file index.html và chọn Open with Live Server (hoặc nhấn nút Go Live ở góc dưới cùng bên phải VS Code).
Ứng dụng sẽ tự động mở trên trình duyệt tại địa chỉ mặc định http://127.0.0.1:5500.
...
Thiết lập lương: Nhập số tiền lương mỗi giờ của bạn tại phần cài đặt cấu hình ban đầu.
Vào ca:
...
Hết ca: Khi hoàn thành công việc, bấm Hết ca để hệ thống tự động cộng tiền và lưu vào lịch sử.
Thêm Thưởng/Chi Tiêu: Sử dụng biểu mẫu nhập để ghi nhận phần thưởng (như ship nước, thưởng doanh số...) hoặc chi tiêu cá nhân (như mua bánh mì) trong ngày.
Theo dõi tiến độ: Tích chọn chất lượng ca làm (Tốt/Xấu) để tích lũy cột mốc nhận thưởng 100.000đ.
Xem báo cáo: Chuyển qua tab Lịch sử & Thống kê để xem chi tiết tình hình tài chính của bạn.
